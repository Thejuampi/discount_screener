...
- **Valuation path `/33` is feature-conditional.** Hold, industry FCFF margin, quality discount, bank through-cycle ROE, and reinvestment stories come from our drivers. Street is the scoreboard only.
