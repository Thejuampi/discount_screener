 ...
 *
 * One symbol there costs a whole companyfacts file: 4.28 MB on average over twenty real files. The
 * sieve keeps about 3% of one, measured on Apple's. Paid once per symbol on a bulk load, that file was 77% of the load in
