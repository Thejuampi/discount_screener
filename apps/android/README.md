...
- **Plans tab** (after Market): Dip hunter. `:core` filters the named `opportunities` universe with F, a signed ATR dip vs the 20-day high, RSI easing in 25–45, MACD histogram ≤ 0 and turning, and Street 12-month target ≥ 20%. DCF / residual income is a tag. Death cross stays in and is tagged. The tab does not fetch extra Yahoo data and does not change V2/V3/V4 scores. Spec: `_bmad-output/implementation-artifacts/dip-board-spec-v1.md`.
