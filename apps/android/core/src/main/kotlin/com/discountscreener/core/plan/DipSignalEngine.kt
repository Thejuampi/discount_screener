...
object DipSignalEngine {
    ...
    fun classify(input: DipRowInput, tape: DipTape?): DipSetup {
        ...
        var evidence = buildEvidence(input.fundamentalsScore, tape, streetBps, valuation, tags)
        return DipSetup(
            symbol = input.symbol,
