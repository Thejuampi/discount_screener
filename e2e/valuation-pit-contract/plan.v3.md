# `plan.v3.md` — Valuation PIT & Contract (E2E session `valuation-pit-contract`)

Branch: `valuation/wave1-integration` · Repo: `G:\dev\repos\discount_screener`
Supersedes `plan.v2.md` in full. This is a replacement plan, not a patch.
...
`plan-review/r1-consolidated-directives.md`, the r2 round, and the **r3 round (Sensei `revise`, 12
P0 / 5 passes; Advisor `revise`, 2 P0 / 5 passes)** → `refine.md` → `plan.v2.md` (preserved where
unfaulted).
...
together. Rebuilding the growth engine. Re-capturing `core_driver_data_deep.json`. **LD-2, LD-3, LD-5, LD-6,
LD-7, LD-8 and LD-9**, each with its trigger condition and detector recorded (D7).
...
## 9. Changelog, v0 to v1 (retained for the record)
