...
3. Give each the same brief: current plan or question, locked stance, mandatory docs list (Advisor), and that this is a new thread unless a prior `sensei-r*.md` / `advisor-r*.md` exists for this decision. Advisor's mandatory docs always include `AGENTS.md`, `_bmad-output/project-context.md`, and `docs/operational-anti-patterns.md`.
