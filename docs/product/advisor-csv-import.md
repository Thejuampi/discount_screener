...
Windows Advisor and Android Import book. The [shared contract](../../shared/contracts/advisor-csv-import-v1.yaml) owns parse and merge behavior.
...
- Positions shows every lot with stock exposure and research labels. See [Android Positions](android-positions.md).
