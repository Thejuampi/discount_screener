...
- [Pre-Earnings Risk Gate PRD](../_bmad-output/planning-artifacts/prd-pre-earnings-risk-gate-2026-08-27.md) - Android-only. Cell is implied-move vs median |AR| on a DCF-cheapness matrix. SUE slope is a card diagnostic. Own last-four revenue trail can cut a Hold to half size. Knobs: [`earnings-gate-policy.yaml`](../shared/contracts/earnings-gate-policy.yaml).
