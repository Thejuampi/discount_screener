...
The [Windows agent guide](../../apps/windows/AGENTS.md) also requires the `qa` profile.
...
`docs/archive/bmad/implementation-artifacts/live-qa-wave1-ds-ui-2026-08-01.md`.
