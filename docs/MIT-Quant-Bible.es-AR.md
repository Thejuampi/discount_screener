...
<div align="center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 781 415" width="781" height="415" role="img" aria-labelledby="title desc">
          <title id="title">Gráfico de densidad de probabilidad</title>
          <desc id="desc">Una curva vectorizada de densidad de probabilidad con x en el eje horizontal de 0 a 16 y la densidad de probabilidad en el eje vertical de 0 a 0,3.</desc>
          <style>
            .bg { fill: #ffffff; }
            .grid { stroke: #9f9f9f; stroke-width: 1.15; stroke-dasharray: 1.6 2.2; stroke-linecap: round; }
            .axis { stroke: #111111; stroke-width: 3; stroke-linecap: square; }
            .tick { stroke: #111111; stroke-width: 1.4; }
            .tick-label { fill: #111111; font-family: Arial, Helvetica, sans-serif; font-size: 20px; }
            .axis-label { fill: #111111; font-family: Arial, Helvetica, sans-serif; font-size: 22px; font-weight: 700; }
            .curve { fill: none; stroke: #ce7163; stroke-width: 2.8; stroke-linecap: round; stroke-linejoin: round; }
          </style>
          <rect class="bg" width="100%" height="100%" />

          <g aria-hidden="true">
            <line class="grid" x1="185.00" y1="30.0" x2="185.00" y2="333.0" />
            <line class="grid" x1="266.00" y1="30.0" x2="266.00" y2="333.0" />
            <line class="grid" x1="347.00" y1="30.0" x2="347.00" y2="333.0" />
            <line class="grid" x1="428.00" y1="30.0" x2="428.00" y2="333.0" />
            <line class="grid" x1="509.00" y1="30.0" x2="509.00" y2="333.0" />
            <line class="grid" x1="590.00" y1="30.0" x2="590.00" y2="333.0" />
            <line class="grid" x1="671.00" y1="30.0" x2="671.00" y2="333.0" />
            <line class="grid" x1="752.00" y1="30.0" x2="752.00" y2="333.0" />
            <line class="grid" x1="104.0" y1="282.50" x2="752.0" y2="282.50" />
            <line class="grid" x1="104.0" y1="232.00" x2="752.0" y2="232.00" />
            <line class="grid" x1="104.0" y1="181.50" x2="752.0" y2="181.50" />
            <line class="grid" x1="104.0" y1="131.00" x2="752.0" y2="131.00" />
            <line class="grid" x1="104.0" y1="80.50" x2="752.0" y2="80.50" />
            <line class="grid" x1="104.0" y1="30.00" x2="752.0" y2="30.00" />
            <line class="grid" x1="104.0" y1="30.0" x2="752.0" y2="30.0" />
            <line class="grid" x1="752.0" y1="30.0" x2="752.0" y2="333.0" />
          </g>

          <g aria-hidden="true">
            <line class="axis" x1="104.0" y1="30.0" x2="104.0" y2="333.0" />
            <line class="axis" x1="104.0" y1="333.0" x2="752.0" y2="333.0" />
            <line class="tick" x1="104.00" y1="333.0" x2="104.00" y2="340.0" />
            <line class="tick" x1="185.00" y1="333.0" x2="185.00" y2="340.0" />
            <line class="tick" x1="266.00" y1="333.0" x2="266.00" y2="340.0" />
            <line class="tick" x1="347.00" y1="333.0" x2="347.00" y2="340.0" />
            <line class="tick" x1="428.00" y1="333.0" x2="428.00" y2="340.0" />
            <line class="tick" x1="509.00" y1="333.0" x2="509.00" y2="340.0" />
            <line class="tick" x1="590.00" y1="333.0" x2="590.00" y2="340.0" />
            <line class="tick" x1="671.00" y1="333.0" x2="671.00" y2="340.0" />
            <line class="tick" x1="752.00" y1="333.0" x2="752.00" y2="340.0" />
            <line class="tick" x1="97.0" y1="333.00" x2="104.0" y2="333.00" />
            <line class="tick" x1="97.0" y1="282.50" x2="104.0" y2="282.50" />
            <line class="tick" x1="97.0" y1="232.00" x2="104.0" y2="232.00" />
.53,322.90 472.55,323.16 474.57,323.42 476.60,323.67 478.62,323.91 480.65,324.14 482.68,324.37 484.70,324.60 486.72,324.81 488.75,325.02 490.78,325.23 492.80,325.43 494.82,325.62 496.85,325.81 498.88,325.99 500.90,326.17 502.93,326.34 504.95,326.51 506.97,326.68 509.00,326.84 511.03,326.99 513.05,327.14 515.08,327.29 517.10,327.44 519.12,327.58 521.15,327.71 523.17,327.84 525.20,327.97 527.22,328.10 529.25,328.22 531.28,328.34 533.30,328.45 535.33,328.57 537.35,328.68 539.38,328.78 541.40,328.89 543.42,328.99 545.45,329.09 547.47,329.18 549.50,329.28 551.53,329.37 553.55,329.45 555.58,329.54 557.60,329.63 559.62,329.71 561.65,329.79 563.67,329.86 565.70,329.94 567.72,330.01 569.75,330.09 571.78,330.16 573.80,330.22 575.83,330.29 577.85,330.36 579.88,330.42 581.90,330.48 583.92,330.54 585.95,330.60 587.97,330.66 590.00,330.71 592.03,330.76 594.05,330.82 596.08,330.87 598.10,330.92 600.12,330.97 602.15,331.02 604.17,331.06 606.20,331.11 608.22,331.15 610.25,331.19 612.28,331.24 614.30,331.28 616.33,331.32 618.35,331.36 620.38,331.39 622.40,331.43 624.42,331.47 626.45,331.50 628.48,331.54 630.50,331.57 632.52,331.60 634.55,331.63 636.58,331.67 638.60,331.70 640.62,331.73 642.65,331.75 644.67,331.78 646.70,331.81 648.73,331.84 650.75,331.86 652.77,331.89 654.80,331.91 656.83,331.94 658.85,331.96 660.88,331.98 662.90,332.01 664.92,332.03 666.95,332.05 668.98,332.07 671.00,332.09 673.02,332.11 675.05,332.13 677.08,332.15 679.10,332.17 681.12,332.19 683.15,332.21 685.17,332.22 687.20,332.24 689.23,332.26 691.25,332.27 693.27,332.29 695.30,332.30 697.33,332.32 699.35,332.33 701.38,332.35 703.40,332.36 705.42,332.38 707.45,332.39 709.48,332.40 711.50,332.42" />

          <g>
            <text class="tick-label" x="104.00" y="365" text-anchor="middle">0</text>
            <text class="tick-label" x="185.00" y="365" text-anchor="middle">2</text>
            <text class="tick-label" x="266.00" y="365" text-anchor="middle">4</text>
            <text class="tick-label" x="347.00" y="365" text-anchor="middle">6</text>
            <text class="tick-label" x="428.00" y="365" text-anchor="middle">8</text>
            <text class="tick-label" x="509.00" y="365" text-anchor="middle">10</text>
            <text class="tick-label" x="590.00" y="365" text-anchor="middle">12</text>
            <text class="tick-label" x="671.00" y="365" text-anchor="middle">14</text>
            <text class="tick-label" x="752.00" y="365" text-anchor="middle">16</text>
            <text class="tick-label" x="90" y="338.00" text-anchor="end">0</text>
            <text class="tick-label" x="90" y="287.50" text-anchor="end">0.05</text>
            <text class="tick-label" x="90" y="237.00" text-anchor="end">0.1</text>
            <text class="tick-label" x="90" y="186.50" text-anchor="end">0.15</text>
            <text class="tick-label" x="90" y="136.00" text-anchor="end">0.2</text>
            <text class="tick-label" x="90" y="85.50" text-anchor="end">0.25</text>
            <text class="tick-label" x="90" y="35.00" text-anchor="end">0.3</text>
            <text class="axis-label" x="428.00" y="400" text-anchor="middle">X</text>
            <text class="axis-label" x="24" y="181.50" transform="rotate(-90 24 181.50)" text-anchor="middle">Densidad de probabilidad</text>
          </g>
        </svg>
        </div>
