...
<div align="center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 781 415" width="781" height="415" role="img" aria-labelledby="title desc">
          <title id="title">Probability density graph</title>
          <desc id="desc">A vectorized probability density curve with x on the horizontal axis from 0 to 16 and probability density on the vertical axis from 0 to 0.3.</desc>
          <style>
            .bg { fill: #ffffff; }
          ...
          <g>
            ...
            <text class="axis-label" x="24" y="181.50" transform="rotate(-90 24 181.50)" text-anchor="middle">Probability density</text>
          </g>
        </svg>
        </div>
